//Capa
const nomeCarga = "Programação de Chaves Tracker T19";
...
const lstFunc = [
`Programação de até 4 chaves no veículo`,
``,
`Observações:`,
`- As chaves programadas ficarão dedicadas somente para este veículo. As chaves programadas não funcionarão em outro veículo.`,
`- Essa carga permite somente a programação de chaves, não permitira apagar as chaves antigas, nem verificar a quantidades de chaves já programadas no veículo. No caso de adicionar uma 5ª chave, uma das chaves anteriores deixará de funcionar.`,
...
const resources = [
{title: "", 
description: "Utilize uma chave azul, T19 (ID 46) locado, dedicado Suzuki.", 
image: "../public/images/Chaves e Telecomandos/Chave azul t19 GM.jpg"},
...
image: "../public/images/Acessórios/Obdmap mais Cabo Universal mais Adaptador A2 CONECTADOS.jpg"},
