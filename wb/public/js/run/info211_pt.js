//Capa
const nomeCarga = "Leitura de senha ECU GM Delco E83 via OBD";
const revCarga = "Rev. 0";
const dataManual = "Setembro 2015";
...
const applicationObs = createObs("Atenção!", "Existem outros veículos que utilizam essa ECU, porem não será possível realizar a leitura da senha com esta carga.", undefined)
